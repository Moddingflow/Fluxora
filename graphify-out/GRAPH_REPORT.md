# Graph Report - Fluxora  (2026-07-12)

## Corpus Check
- 841 files · ~1,250,284 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19165 nodes · 42043 edges · 882 communities (853 shown, 29 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 392 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `386d434a`
...
## Communities (882 total, 29 thin omitted)
...
Cohesion: 0.05
Nodes (72): AiBuildContextSnapshot, AiReadOnlyBuildToolName, acceptedMutation(), AiBasicBuildArchiveImportRequest, AiBasicBuildDeleteModRequest, AiBasicBuildDiffChange, AiBasicBuildDiffChangeType, AiBasicBuildExecutionApproval (+64 more)
...
Cohesion: 0.03
Nodes (101): addManualContextText(), applyGlobalBarLabelState(), applyPlaceholderSizingStyles(), averageRgb01(), buildAnnotationsForCapture(), buildPinElement(), buildSvelteExpressionTextMap(), buildSveltePropValuesFromLiveElement() (+93 more)
...
Cohesion: 0.05
Nodes (79): AiAutonomousJobStorage, serializeAiBuildContextSnapshot(), AiHostRunSettings, AiLocalRunCallbacks, AiPromptFingerprint, aiResponseDiagnosticMessages(), AiRuntimeLogChannel, AiRuntimeLogEntry (+71 more)
...
Cohesion: 0.06
Nodes (56): DownloadTransferLimiter, Permit, uint32_t, uintmax_t, DownloadProgressWriteMode, acquireDownloadTransferPermit(), currentUnixSeconds(), DownloadCanceledException (+48 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (88): MissingMastersStatus(), MissingMastersStatusProps, tooltipLabel(), TooltipPlacement, TooltipPosition, DownloadCapabilityView, downloadDisplayName(), downloadProgressValue() (+80 more)
...
Cohesion: 0.13
Nodes (44): DownloadEntry, NxmDownloadJob, string_view, ActiveDownloadClaim, path_, transferred_, buildEntry(), cancelDownload() (+36 more)
...
Cohesion: 0.03
Nodes (122): AiChatSettings, AiProviderDiagnostic, aiRoutingPresetOptions, connectedRemoteDefaultModelId(), defaultAiChatSettings, hostStatusErrorDetail(), isLocalDryRunProvider(), isRoutingPreset() (+114 more)
...
Cohesion: 0.02
Nodes (157): finalCaseStateFromResponse(), affectedModsForClaim(), allowedDomainsForPlan(), boundedId(), buildCaseStateSummary(), BuilderInput, buildExternalCandidate(), buildExternalConflicts() (+149 more)
...
Cohesion: 0.09
Nodes (50): set, size_t, string, uint16_t, uint64_t, wchar_t, HKEY, runtime_error (+42 more)
...
Cohesion: 0.03
Nodes (69): Bad, Benefits, Good, Hybrid Approach, Module Structure, proj-mod-by-feature, See Also, Shared Code (+61 more)
...
Cohesion: 0.06
Nodes (104): error_code, FomodInstallerDescriptor, function, HANDLE, Logger, map, optional, path (+96 more)
...
Cohesion: 0.32
Nodes (22): JsonValue, uintmax_t, vector, wstring_view, arraySize(), containsAny(), parseFluxPackManifest(), processedProviderSources() (+14 more)
...
Cohesion: 0.16
Nodes (19): AppSettingsService, buildNexusAuthHeader(), fetchNexusFileInfo(), fetchNexusModName(), nexusAuthUnavailableMessage(), NexusFileInfo, fileName, payloadJson (+11 more)
...
Cohesion: 0.05
Nodes (47): condition_variable, deque, DownloadTransferLimiter, mutex, NxmDownloadJob, DownloadService, vector, AppSettingsService (+39 more)
...
Cohesion: 0.03
Nodes (87): AiBuildToolRuntimeContext, AiBasicBuildExecutionContext, detailMetrics(), hasStatValue(), hiddenStatValues, LibraryCatalogState, LibraryHome(), LibraryHomeProps (+79 more)
...
Cohesion: 0.09
Nodes (41): BuildPathSettings, FluxPackContentStoreStatistics, FluxPackPackageType, FluxPackStoredChunk, InstalledModRecord, JsonWriter, ProfileOrderItemRecord, ProjectOpenResult (+33 more)
...
Cohesion: 0.11
Nodes (70): BuildPathSettingsService, ExistingModInstallMode, InstalledMod, PlacementOverride, PlacementPlan, vector, wstring, wstring_view (+62 more)
...
Cohesion: 0.06
Nodes (60): createAiRunForPrompt(), normalizePersistedAiSession(), recoverAiSessionAfterRestart(), AiRoutingPresetOption, activeAiChatThread(), activeRunForChat(), aiAgentStatusFromSubagentStatus(), AiChatAction (+52 more)
...
Cohesion: 0.09
Nodes (41): String, cleaned_process_names(), downloads_folder_batch_reason(), DownloadsFolderChange, encode_query_component(), find_process_by_names(), fluxora_ai_chat_respond(), fluxora_ai_estimate_context() (+33 more)
...
Cohesion: 0.09
Nodes (65): abortSvelteComponentInjection(), applyEditing(), buildLocatorForLeaf(), buildPickedAnchorSnapshot(), cancelEditing(), cancelEditingToPicking(), cancelInsertConfigure(), cleanup() (+57 more)
...
Cohesion: 0.07
Nodes (30): AliasedExistingPartialPathCanOnlyHaveOneActiveOwner, AutomaticNexusDownloadsRequireLinkedPremiumAccount, CanceledQueuedNexusTransferDoesNotEnterTransportAfterSlotRelease, CaptureNxmLinkWithOAuthAuthWithoutApiKeyQueuesOAuthDownload, CaptureNxmLinkWithoutDownloadKeyQueuesAuthenticatedDownload, ConcurrentAliasedNamesReserveDistinctOutputPaths, ConcurrentResumeClaimsPendingDownloadOnce, ConcurrentShutdownJoinsWorkerPoolOnce (+22 more)
...
Cohesion: 0.01
Nodes (212): AiBasicBuildExecutionRequest, AI_SAFE_ACTION_CATALOG, AI_SAFE_ACTION_TOOL_NAMES, AiSafeActionCatalog, FluxoraSkillCatalog, CreateFluxoraProjectRequest, DialogPickResult, DialogSaveResult (+204 more)

### Community 319 - "Community 319"
Cohesion: 0.02
Nodes (124): AiLocalRunHandle, FluxPackInstallConflictDialog(), FluxPackInstallConflictDialogProps, FluxPackManualDownloadsDialog(), FluxPackManualDownloadsDialogProps, dialogCopyByKind, ModCreationDialog(), ModCreationDialogKind (+116 more)
...
Cohesion: 0.10
Nodes (44): FluxPackInstallPlan, FluxPackInstallResult, size_t, string, unordered_map, wstring, FluxPackInstallPlanRequest, FluxPackInstallRequest (+36 more)

### Community 346 - "Community 346"
Cohesion: 0.05
Nodes (83): AI_READ_ONLY_BUILD_TOOLS, appendOverwriteOrderItem(), appendOverwriteStateMarkers(), conflictMarkerStateOrder, conflictStatusLooksRelevant(), createOverwriteOrderItem(), emptyModWorkspaceState(), filterModOrderItems() (+75 more)
...
Cohesion: 0.13
Nodes (14): Bad, doc-crate-readme, Good, Handling Non-Rust Code Blocks in README, See Also, Why It Matters, Bad, Crate Root Example (+6 more)
...
Cohesion: 0.19
Nodes (13): DownloadEntry, InstalledMod, InstalledModRecord, ModFileSummaryRecord, optional, wstring, wstring_view, findInstalledMod() (+5 more)
...
Cohesion: 0.08
Nodes (37): AiHostProcess, AtomicU32, AtomicU64, BridgeProcess, BuildContentWatcher, DebouncedEvent, DebounceEventResult, Default (+29 more)
...
Cohesion: 0.06
Nodes (53): AI_MOD_RESEARCH_PIPELINE_SCHEMA_IDS, createAiExternalInvestigation(), createAiLocalInspection(), createAiModResearchEvidenceCard(), createAiModResearchRoute(), createAiNexusInvestigation(), createAiWebQueryPlan(), DEFAULT_AI_NON_NEXUS_WEB_SOURCE_POLICY (+45 more)
...
Cohesion: 0.04
Nodes (45): Bad, Generic Functions, Good, Inline Variants, Measuring Inline Impact, opt-inline-always-rare, See Also, When #[inline(always)] Helps (+37 more)
...
Cohesion: 0.10
Nodes (19): Bad, CI Integration, Good, Lint Categories, lint-workspace-lints, Per-Crate Overrides, Recommended Lint Configuration, See Also (+11 more)
...
Cohesion: 0.31
Nodes (19): ProfileModOrderItem, size_t, string_view, uint64_t, uint8_t, vector, bytesFromString(), bytesToString() (+11 more)
...
Cohesion: 0.09
Nodes (24): buildDownloadIndex(), DownloadMetadata, destinationFileName, fileId, gameDomain, latestVersion, modId, nexusModName (+16 more)
...
Cohesion: 0.02
Nodes (80): Acceptable Ignoring (Documented), anti-empty-catch, Bad, Clippy Lint, Decision Guide, Good, Pattern: Best-Effort Operations, Pattern: Collect and Report (+72 more)
...
Cohesion: 0.03
Nodes (63): Bad, doc-examples-section, Good, Hide Setup Code, Multiple Examples, Running Doc Tests, See Also, Show Error Cases (+55 more)
...
Cohesion: 0.09
Nodes (23): FluxPackPayloadReference, ModSourceRecord, FluxPackConfigReference, embedsText, payload, relativePath, sha256, size (+15 more)
...
Cohesion: 0.02
Nodes (118): Bad, coll-binaryheap, Good, Max-heap vs Min-heap at a glance, See Also, Why It Matters, Bad, coll-map-choice (+110 more)
...
Cohesion: 0.09
Nodes (20): Assertions and Invariants, Bad, Combining with #[inline(never)], Common Cold Patterns, Good, Measuring Impact, opt-cold-unlikely, See Also (+12 more)
...
Cohesion: 0.06
Nodes (30): anti-type-erasure, Bad, Comparison, Good, impl Trait Positions, Pattern: Enum Instead of dyn, See Also, When to Use Box<dyn Trait> (+22 more)
...
## Knowledge Gaps
- **8295 isolated node(s):** `COMMON_DEV_PORTS`, `SCANNABLE_EXT`, `SOURCE_DIRS`, `PRODUCT_NAMES`, `DESIGN_NAMES` (+8290 more)
...
- **Why does `thread` connect `Community 643` to `Community 4`, `Community 7`, `Community 26`, `Community 285`, `Community 159`, `Community 165`, `Community 294`, `Community 181`, `Community 56`, `Community 58`, `Community 196`, `Community 70`, `Community 585`, `Community 87`, `Community 221`, `Community 349`, `Community 96`, `Community 110`, `Community 255`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `PathSafetyService` connect `Community 268` to `Community 0`, `Community 96`, `Community 4`, `Community 388`, `Community 70`, `Community 7`, `Community 105`, `Community 11`, `Community 436`, `Community 23`, `Community 22`, `Community 87`, `Community 58`, `Community 124`, `Community 349`, `Community 350`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `IService` connect `Community 582` to `Community 32`, `Community 486`, `Community 40`, `Community 172`, `Community 109`, `Community 110`, `Community 433`, `Community 179`, `Community 115`, `Community 117`, `Community 21`, `Community 183`, `Community 536`, `Community 57`, `Community 219`, `Community 28`, `Community 543`?**
