# Graph Report - Fluxora  (2026-07-04)

## Corpus Check
- 768 files · ~1,011,005 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17086 nodes · 36372 edges · 815 communities (788 shown, 27 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 295 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d6bac633`
...
## Communities (815 total, 27 thin omitted)
...
Cohesion: 0.14
Nodes (28): string, string_view, base64UrlDecode(), buildNexusApiValidationError(), buildNexusTokenRequestBodyForTest(), buildTokenErrorMessage(), buildTokenRequestBody(), CallbackResult (+20 more)
...
Cohesion: 0.04
Nodes (43): AI_CHAT_MARKDOWN_POLICY, isAiContextSourceUrl(), safeAiExternalUrl(), safeAiSourceUrl(), sanitizeAiChatText(), AiChatState, AiContextEstimateState, aiStatusLabels (+35 more)
...
Cohesion: 0.08
Nodes (36): Entry, ai_credential_available(), ai_credential_entry(), ai_intermediate_event_validator_redacts_and_rejects_unknown_notifications(), ai_provider_state_preserves_host_supabase_connection(), AppInfo, arch_name(), bracket_field() (+28 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (105): addManualContextText(), applyGlobalBarLabelState(), applyPlaceholderDimensions(), applyPlaceholderSizingStyles(), averageRgb01(), beginEditPin(), buildAnnotationsForCapture(), buildPinElement() (+97 more)
...
Cohesion: 0.04
Nodes (99): addConflictEvidenceFile(), AI_ALL_READ_ONLY_BUILD_TOOLS, AI_BUILD_CONTEXT_TOOL_SEMANTICS, AI_ON_DEMAND_ANALYZE_TOOLS, AiBuildIssueSeverity, AiBuildOperationHint, AiBuildToolIssue, AiBuildToolPermissionClass (+91 more)
...
Cohesion: 0.07
Nodes (52): createAiRunForPrompt(), normalizePersistedAiSession(), AiRoutingPresetOption, activeAiChatThread(), activeRunForChat(), aiAgentStatusFromSubagentStatus(), AiChatAction, aiChatReducer() (+44 more)
...
Cohesion: 0.03
Nodes (103): InstallDialog(), InstallDialogPhase, InstallDialogProps, InstallDialogState, InstallIconStyle, AssetIconStyle, backgroundReorderLoadOptions, CatalogState (+95 more)
...
Cohesion: 0.06
Nodes (32): Async Tests, Bad, Complex Arrange, Good, Helper Functions, See Also, test-arrange-act-assert, Why It Matters (+24 more)
...
Cohesion: 0.06
Nodes (54): AiAutonomousJobStorage, serializeAiBuildContextSnapshot(), AiHostRunSettings, AiLocalRunHandle, AiPromptFingerprint, aiResponseDiagnosticMessages(), AiRuntimeLogChannel, AiRuntimeLogEntry (+46 more)
...
Cohesion: 0.13
Nodes (37): atomic_bool, CapabilitySet, ContentArea, ContentLayoutAnalysisRequest, ContentLayoutArchiveEntry, ContentLayoutClassification, GameRelativePath, HealthSeverity (+29 more)
...
Cohesion: 0.07
Nodes (23): AppSettingsService, BuildPathSettingsService, DownloadService, Logger, ModService, path, ProfileOrderService, ScopedEnvironmentVariable (+15 more)
...
Cohesion: 0.16
Nodes (32): initializer_list, optional, wstring, wstring_view, defaultNexusRedirectUriForTest(), firstTrimmedEnvironmentValue(), formatUtcExpiry(), hostIsAllowedSupabase() (+24 more)
...
Cohesion: 0.14
Nodes (20): AppSettingsService, Logger, map, NexusModsApiAuthHeader, NexusModsAuthService(), size_t, vector, apiAuthHeader() (+12 more)
...
Cohesion: 0.16
Nodes (19): AiProviderDiagnostic, aiRoutingPresetOptions, connectedRemoteDefaultModelId(), defaultAiChatSettings, formatAiCost(), hostStatusErrorDetail(), isLocalDryRunProvider(), isRoutingPreset() (+11 more)
...
Cohesion: 0.15
Nodes (17): JsonValue, ApiKeyUser, userId, username, extractSupabaseCredentialValue(), extractSupabaseCredentialValueForTest(), parseTokenResponse(), readFirstJsonString() (+9 more)

### Community 158 - "Community 158"
Cohesion: 0.06
Nodes (44): AppSettingsService, BuildPathSettingsService, ExecutableIconService, ExecutableService, InstalledModRecord, Logger, ModService, path (+36 more)

### Community 159 - "Community 159"
Cohesion: 0.09
Nodes (26): activationScore(), createFluxoraSkillContextNodes(), FLUXORA_BUILT_IN_SKILL_IDS, FLUXORA_BUILT_IN_SKILLS, FLUXORA_SKILL_CATALOG, FLUXORA_SKILL_CATALOG_CAPABILITY, FluxoraBuiltInSkillId, FluxoraSkill (+18 more)
...
Cohesion: 0.13
Nodes (25): BufReader, Child, ChildStdin, ChildStdout, Value, ai_context_usage_fallback(), ai_request_context_window_tokens(), ai_request_estimated_context_tokens() (+17 more)
...
Cohesion: 0.06
Nodes (109): AtomicUsize, Duration, Arc, Client, Drop, HashSet, Map, Mutex (+101 more)
...
Cohesion: 0.33
Nodes (9): agent_result_value(), AgentRunResult, provider_account_or_quota_error(), provider_credential_rejected_error(), provider_error_message_contains(), provider_fallback_reason(), ProviderChatError, retryable_status() (+1 more)
...
Cohesion: 0.09
Nodes (22): HookService, ProfileService, initialize, initialized_, isInitialized, shutdown, Logger, IService (+14 more)
...
Cohesion: 0.11
Nodes (38): Result, String, encode_query_component(), fluxora_build_settings_paths_saved(), fluxora_current_executable(), fluxora_list_destination_drives(), fluxora_log(), fluxora_open_build_settings_window() (+30 more)
...
Cohesion: 0.26
Nodes (13): addProfileTextFileCandidates(), collectModTextFileCandidatesDirectory(), displayPathSegment(), extensionForRelativePath(), localFileSample(), localReadTextFilePathAllowed(), localReadTextFilePriority(), normalizeLocalPath() (+5 more)

### Community 196 - "Community 196"
Cohesion: 0.13
Nodes (26): BuildPathSettingsService, ExecutableService, function, GrassCacheLaunchSpec, Logger, ModService, optional, ProfileOrderService (+18 more)
...
Cohesion: 0.04
Nodes (84): AiBuildToolRuntimeContext, AiChatSettings, AiBasicBuildExecutionContext, AiSettingsPanelProps, capabilityStateLabel(), currentPlatformSupport(), findTransferDriveForPath(), formatLastBuildDate() (+76 more)
...
Cohesion: 0.13
Nodes (42): DirChild, FILETIME, LARGE_INTEGER, size_t, unordered_map, WIN32_FIND_DATAW, wstring, wstring_view (+34 more)
...
Cohesion: 0.10
Nodes (25): path, string, wstring, CreateProjectCleansExistingProjectDirectory, CreateProjectCreatesMissingInstallRoot, CreateProjectRejectsUnsafeInstallRoot, CreateProjectRemovesAutoCreatedInstallRootAfterFailure, CreateSkyrimProjectRejectsMissingRequiredFiles (+17 more)
...
Cohesion: 0.09
Nodes (33): candidate_skill_ids_for_prompt(), decide_mod_research_route(), enabled_research_params(), gemini_count_tokens_body_wraps_matching_generate_content_request(), gemini_generate_content_request_body(), local_missing_fields(), missing_masters_route_is_local_only_and_has_no_search_budget(), ModResearchRouteDecision (+25 more)
...
Cohesion: 0.04
Nodes (51): anti-type-erasure, Bad, Comparison, Good, impl Trait Positions, Pattern: Enum Instead of dyn, See Also, When to Use Box<dyn Trait> (+43 more)
...
Cohesion: 0.02
Nodes (151): AiBasicBuildExecutionRequest, AI_SAFE_ACTION_CATALOG, AI_SAFE_ACTION_TOOL_NAMES, AiSafeActionCatalog, FluxoraSkillCatalog, CreateFluxoraProjectRequest, DialogPickResult, DialogSaveResult (+143 more)
...
Cohesion: 0.07
Nodes (56): assumptions_for_kind(), bool_param(), budget_tier_for(), build_context_message(), build_local_inspection(), build_preparation_steps(), chat_messages(), compatibility_steps() (+48 more)
...
Cohesion: 0.13
Nodes (27): chat_respond_emits_canonical_intermediate_event_notifications(), endpoint_for_provider(), event_id_part(), local_inspection_id(), local_inspection_slug(), local_inspection_tool_source_ids(), local_provider_credential(), local_reply() (+19 more)
...
Cohesion: 0.18
Nodes (17): AiIntermediateEventEmitter<'a>, build_context_snapshot_from_messages(), CostComputation, extract_json_with_schema(), extract_supabase_credential_value(), fetch_url_calls_for(), normalize_supabase_credential(), provider_supabase_secret_name() (+9 more)
...
Cohesion: 0.19
Nodes (37): AppHandle, Option, ai_connection_result(), ai_host_state(), ai_provider_known(), ai_status_payload(), bridge_state(), build_content_watch_request() (+29 more)
...
Cohesion: 0.18
Nodes (19): Debouncer, PathBuf, RecommendedCache, RecommendedWatcher, ai_host_cargo_binary_name(), ai_host_executable_name(), BuildContentWatcher, candidate_ai_host_paths() (+11 more)
...
Cohesion: 0.10
Nodes (31): BuildContentChange, DownloadsFolderChange, FileDialogBuilder, FilePath, Vec, I, R, add_dialog_filters() (+23 more)
...
Cohesion: 0.18
Nodes (16): DebouncedEvent, DebounceEventResult, EventKind, Path, build_content_area_for_path(), build_content_batch_reason(), build_content_changes(), BuildContentChange (+8 more)
...
Cohesion: 0.14
Nodes (17): ContentLayoutSummary, PlacementPlanEntry, vector, applyPlanToDirectory(), copyThenRemoveFile(), countEntry(), isPlainRegularFile(), isRegularFile() (+9 more)
...
Cohesion: 0.12
Nodes (32): AiResearchBundle, AiResearchCache, AiIntermediateEventEmitter, byok_candidates_include_main_and_orchestration_gemini_models(), candidate_models(), chat_response_with_events(), cost_payload_includes_orchestration_subagent_cost(), emit_chat_event() (+24 more)
...
Cohesion: 0.12
Nodes (37): AgentTarget, available_remote_targets(), call_cost_summary(), call_gemini(), chat_response_payload(), ChatPromptPackage, chef_dispatch_instruction(), choose_orchestration_targets() (+29 more)
...
Cohesion: 0.18
Nodes (12): buildRedirectUri(), callbackPath(), closeClient(), OAuthCallbackListener, actualPort_, redirect_, redirectUri_, responded_ (+4 more)
...
Cohesion: 0.18
Nodes (11): path, uintmax_t, wstring, ProfileTextFilePreview, bytesRead, contentPreview, fileName, path (+3 more)
...
Cohesion: 0.47
Nodes (9): comparePath(), createMo2TransferImportRequest(), normalizeMo2TransferAnalysis(), normalizeMo2TransferDestinationRoot(), normalizeMo2TransferTargetProjectDirectory(), pathLeaf(), pathStartsInside(), trimTrailingSeparators() (+1 more)
...
Cohesion: 0.14
Nodes (18): detectCsp(), INLINE_HEADER_SIGNALS, LAYOUT_EXTS, MONOREPO_HELPER_SIGNALS, NUXT_ROUTE_RULES_SIGNALS, NUXT_SECURITY_SIGNALS, SCAN_EXTS, SKIP_DIRS (+10 more)
...
Cohesion: 0.04
Nodes (50): anti-collect-intermediate, Bad, Comparison, Good, Iterator Methods That Avoid Collection, Pattern: Deferred Collection, See Also, When Collection Is Needed (+42 more)
...
Cohesion: 0.14
Nodes (13): ApiAuthHeaderIsUnavailableWithoutLinkedAccount, ApiAuthHeaderUsesOAuthBearerWhenApiKeyIsAbsent, ApiAuthHeaderUsesProtectedApiKeyForTrustedNativeServices, ApiKeyOnlyAuthIsLinkedForDownloads, AuthorizeAndTokenRequestsUseRegisteredRedirectUri, ClientSecretResolverUsesExpectedNameAndEnvironmentOverride, DefaultRedirectUriUsesRegisteredLoopbackCallback, NexusModsAuthServiceTests (+5 more)
...
Cohesion: 0.03
Nodes (60): anti-string-for-str, Bad, Clippy Detection, Deref Coercion, Good, Pattern: Flexible APIs, See Also, Similar Anti-patterns (+52 more)
...
Cohesion: 0.07
Nodes (21): async-async-fn-bounds, Bad, Good, Key Points, See Also, The Three Variants, Why It Matters, async-cancel-safety (+13 more)
...
Cohesion: 0.11
Nodes (20): AiHostProcess, AtomicU64, BridgeProcess, BuildContentWatcher, Default, DownloadsFolderWatcher, Arc, AsRef (+12 more)
...
Cohesion: 0.09
Nodes (21): AnalyzePlacesDriveRootImportsInsideFluxoraBuilds, AnalyzePlacesFolderImportsInsideFluxoraBuilds, path, BuildPathSettingsServiceTests, ImportCancellationCleansStagingDirectory, ImportCopiesQtByteArrayOverwriteDirectory, ImportCreatesFluxoraBuildsFolderForCyrillicBuildName, ImportPersistsBuildInAppDataCatalogForRestart (+13 more)
...
Cohesion: 0.28
Nodes (9): AiLocalRunCallbacks, AiSupportBundleSnapshot, AiAgentStatus, AiChatThread, AiSession, AiStreamEvent, FluxoraAiContextUsage, FluxoraAiCostLedgerEntry (+1 more)
...
Cohesion: 0.05
Nodes (32): anti-expect-lazy, Bad, Decision Guide, Good, See Also, When expect() Is Appropriate, Why It Matters, anti-unwrap-abuse (+24 more)
...
Cohesion: 0.02
Nodes (115): anti-lock-across-await, Bad, Detection, Good, Pattern: Clone Before Await, Pattern: Restructure to Avoid Lock, See Also, What Can Cross Await (+107 more)
...
Cohesion: 0.02
Nodes (90): Bad, coll-map-choice, Good, See Also, Which to Use, Why It Matters, Bad, coll-seq-choice (+82 more)
...
Cohesion: 0.11
Nodes (17): Bad, Edge Cases, Error Cases, Good, Module Organization, Naming Patterns, See Also, test-descriptive-names (+9 more)
...
Cohesion: 0.09
Nodes (20): Bad, Caveats, Good, Key Points, See Also, serde-custom-with, Why It Matters, Bad (+12 more)
...
Cohesion: 0.13
Nodes (13): Bad, conc-atomic-ordering, Good, Ordering Quick Reference, See Also, Verification with loom, Why It Matters, Bad (+5 more)
...
## Knowledge Gaps
- **7536 isolated node(s):** `COMMON_DEV_PORTS`, `SCANNABLE_EXT`, `SOURCE_DIRS`, `PRODUCT_NAMES`, `DESIGN_NAMES` (+7531 more)
...
- **Why does `thread` connect `Community 285` to `Community 96`, `Community 26`, `Community 4`, `Community 196`, `Community 70`, `Community 7`, `Community 104`, `Community 294`, `Community 168`, `Community 165`, `Community 110`, `Community 85`, `Community 56`, `Community 58`, `Community 60`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `IService` connect `Community 183` to `Community 32`, `Community 34`, `Community 40`, `Community 521`, `Community 10`, `Community 109`, `Community 110`, `Community 498`, `Community 179`, `Community 117`, `Community 150`, `Community 21`, `Community 536`, `Community 377`, `Community 219`, `Community 57`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `PathSafetyService` connect `Community 268` to `Community 0`, `Community 96`, `Community 130`, `Community 67`, `Community 4`, `Community 70`, `Community 7`, `Community 104`, `Community 105`, `Community 11`, `Community 51`, `Community 499`, `Community 22`, `Community 23`, `Community 58`, `Community 60`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **What connects `COMMON_DEV_PORTS`, `SCANNABLE_EXT`, `SOURCE_DIRS` to the rest of the system?**
  _7543 weakly-connected nodes found - possible documentation gaps or missing edges._
