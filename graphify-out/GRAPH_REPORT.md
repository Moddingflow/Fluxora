...
## Corpus Check
- 844 files · ~1,251,961 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19196 nodes · 42103 edges · 886 communities (858 shown, 28 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 392 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ef6aad41`
...
## Communities (886 total, 28 thin omitted)
...
Cohesion: 0.05
Nodes (57): Entry, Value, NativeExitWait, ai_context_usage_fallback(), ai_credential_available(), ai_credential_entry(), ai_intermediate_event_validator_redacts_and_rejects_unknown_notifications(), ai_provider_state_preserves_host_supabase_connection() (+49 more)
...
Cohesion: 0.16
Nodes (60): int64_t, ModFileTreeEntry, ProfileOrderImportItemRecord, wstring_view, ConflictOwnerGroups, RemoteCheckRecord, appendMissingProfileModItems(), appendMissingProfilePluginItems() (+52 more)
...
Cohesion: 0.05
Nodes (50): array, BCRYPT_ALG_HANDLE, BCRYPT_HASH_HANDLE, HANDLE, T, uint32_t, uint64_t, uintmax_t (+42 more)
...
Cohesion: 0.05
Nodes (63): AiAutonomousJobStorage, AiHostRunSettings, AiPromptFingerprint, aiResponseDiagnosticMessages(), AiRuntimeLogChannel, AiRuntimeLogEntry, aiSessionBuildLabel(), AiSessionScope (+55 more)
...
Cohesion: 0.06
Nodes (53): uint32_t, uintmax_t, DownloadProgressWriteMode, currentUnixSeconds(), DownloadMetadata, bytesReceived, destinationFileName, downloadStartedUnix (+45 more)
...
Cohesion: 0.14
Nodes (44): DownloadEntry, NxmDownloadJob, buildEntry(), canAutomaticallyDownloadNexus(), cancelDownload(), cancelMarkerPath(), captureNxmLinks(), deleteDownload() (+36 more)
...
Cohesion: 0.09
Nodes (54): InstalledModRecord, JsonValue, map, ModSourceRecord, optional, set, size_t, string (+46 more)
...
Cohesion: 0.09
Nodes (52): error_code, mutex, optional, path, shared_ptr, Producer, ActiveDownloadClaim, path_ (+44 more)
...
Cohesion: 0.04
Nodes (99): StartMo2TransferOptions, apiLimitProviderSummary(), cachedString(), capabilityStateLabel(), createCheckingNexusAuthStatus(), createInstantNexusAuthStatus(), createVerifiedNexusAuthStatus(), currentPlatformSupport() (+91 more)
...
Cohesion: 0.08
Nodes (53): set, size_t, string, string_view, uint16_t, uint64_t, wchar_t, HKEY (+45 more)
...
Cohesion: 0.05
Nodes (64): ExecutableLaunchMod, InstalledModRecord, path, ResolvedExecutableLaunch, size_t, string, TempDirectory, vector (+56 more)
...
Cohesion: 0.06
Nodes (58): FomodInstallerDescriptor, function, HANDLE, Logger, map, PlacementPlan, ActiveDownloadRegistration, key_ (+50 more)
...
Cohesion: 0.08
Nodes (39): AppSettingsService, DownloadTransferLimiter, HINTERNET, Permit, DownloadService(), acquireDownloadTransferPermit(), buildNexusAuthHeader(), DownloadCanceledException (+31 more)
...
Cohesion: 0.05
Nodes (39): NxmDownloadJob, DownloadService, analyzeDownloadContentLayout, analyzeFomodDownload, analyzeFomodDownloadContentLayout, canAutomaticallyDownloadNexus, cancelDownload, captureNxmLinks (+31 more)
...
Cohesion: 0.03
Nodes (88): AiBuildToolRuntimeContext, AiBasicBuildExecutionContext, detailMetrics(), hasStatValue(), hiddenStatValues, LibraryCatalogState, LibraryHome(), LibraryHomeProps (+80 more)
...
Cohesion: 0.10
Nodes (17): AppSettingsService, DownloadTransferLimiter, path, ScopedEnvironmentVariable, TempDirectory, ModFileOperationsIntegrationTests, appData_, downloads_ (+9 more)
...
Cohesion: 0.25
Nodes (11): ModConflictTreePage, ModFileSummary, applyConflictOwnerSummary(), ConflictOwner, displayName, modId, conflictStateForOwners(), listModConflictTree() (+3 more)
...
Cohesion: 0.13
Nodes (21): int64_t, uint64_t, uintmax_t, wchar_t, comparablePathText(), configureParallaxGenSettings(), fromUtf8(), mixRootBuilderLaunchCacheHash() (+13 more)
...
Cohesion: 0.22
Nodes (21): Option, date_like_explicit_game_domain(), explicit_user_id_parsing_rejects_iso_like_timestamps(), graphql_mod_requirements_body(), graphql_requirements_query_matches_live_nexus_schema(), make_nexus_target(), native_nexus_api_credential(), nexus_api_credential() (+13 more)
...
Cohesion: 0.09
Nodes (46): Result, String, IpAddr, AiResearchBundle, allowed_domain(), bool_param(), bounded_usize_param(), description_requirement_excerpt() (+38 more)
...
Cohesion: 0.05
Nodes (35): path, size_t, error_code, path, string, BulkCopyStopsDuringActiveCancellableFileCopy, CommitRemovesMarker, LoadDescriptorCapturesManagerProcessIdForSessionLifetime (+27 more)
...
Cohesion: 0.29
Nodes (16): HashSet, Map, Vec, collect_targets_from_params(), collect_targets_from_value(), compact_requirement_nodes(), graphql_error_messages(), next_best_non_nexus_queries() (+8 more)
...
Cohesion: 0.11
Nodes (69): BuildPathSettingsService, ExistingModInstallMode, InstalledMod, PlacementOverride, vector, wstring, wstring_view, analyzeContentLayoutForStaging() (+61 more)
...
Cohesion: 0.11
Nodes (31): String, cleaned_process_names(), downloads_folder_batch_reason(), DownloadsFolderChange, encode_query_component(), fluxora_current_executable(), fluxora_list_destination_drives(), fluxora_log() (+23 more)
...
Cohesion: 0.15
Nodes (47): DWORD, error_code, GameExecutableLaunchResult, PathSafetyResult, string, wstring, addRootBuilderLaunchCacheDesiredFile(), collectRootBuilderLaunchCacheDesiredState() (+39 more)
...
Cohesion: 0.01
Nodes (222): AiBasicBuildExecutionRequest, ActiveLaunchProcess, activeProcessPresentation(), executableStem(), fileNameFromPath(), KnownLaunchProcess, normalizedExecutableName(), processDisplayLabel() (+214 more)
...
Cohesion: 0.10
Nodes (13): AiLocalRunCallbacks, AiChatThread, AiSession, AiStreamEvent, FluxoraAiCaseState, FluxoraAiCitation, FluxoraAiContextUsage, FluxoraAiCostLedgerEntry (+5 more)
...
Cohesion: 0.04
Nodes (75): AI_READ_ONLY_BUILD_TOOLS, appendOverwriteOrderItem(), appendOverwriteStateMarkers(), conflictMarkerStateOrder, conflictStatusLooksRelevant(), createOverwriteOrderItem(), emptyModWorkspaceState(), filterModOrderItems() (+67 more)

### Community 347 - "Community 347"
Cohesion: 0.18
Nodes (11): serializeAiBuildContextSnapshot(), createAiHostChatRequest(), createAiResearchRequestForPrompt(), createAiSupportBundleSnapshot(), recoverAiChatAfterRestart(), startHostAiRun(), startLocalAiRun(), createAiMessage() (+3 more)
...
Cohesion: 0.09
Nodes (61): BuildPathSettingsService, ExecutableIconService, ExecutableLaunchMod, GameExecutable, JsonValue, JsonWriter, Logger, Object (+53 more)
...
Cohesion: 0.31
Nodes (7): DownloadEntry, InstalledMod, optional, wstring, ZipEntry, content, path

### Community 381 - "Community 381"
Cohesion: 0.16
Nodes (21): Value, HashMap, AiResearchCache, api_status_from_snapshot(), api_status_value(), blocked_snapshot(), CachedResearchSnapshot, fetch_public_page_snapshot() (+13 more)
...
Cohesion: 0.16
Nodes (38): AtomicU64, DebounceEventResult, Option, ProcessInfo, ai_connection_result(), ai_status_payload(), build_content_watch_generation_is_current(), build_content_watch_install_is_current() (+30 more)

### Community 399 - "Community 399"
Cohesion: 0.08
Nodes (31): AiHostProcess, AtomicU32, BridgeProcess, BufReader, BuildContentWatcher, Child, ChildStdin, ChildStdout (+23 more)
...
Cohesion: 0.07
Nodes (25): anti-premature-optimize, Bad, Common Premature Optimizations, Document Optimizations, Good, Optimization Principles, Profile Tools, Profiling Workflow (+17 more)

### Community 421 - "Community 421"
Cohesion: 0.13
Nodes (34): AppHandle, Result, ai_host_state(), ai_provider_known(), bridge_queue_performance_message(), bridge_state(), clear_operation_cancel_marker(), enrich_ai_request_with_private_nexus_credential() (+26 more)
...
Cohesion: 0.18
Nodes (21): AtomicUsize, Arc, JoinHandle, NexusApiFixtureWithRequests, batch_requirement_audit_uses_local_nexus_targets_and_reports_coverage(), collect_ai_research_bundle(), http_json_response(), local_snapshots_accept_structured_nexus_identity_and_known_fields() (+13 more)
...
Cohesion: 0.17
Nodes (16): DebouncedEvent, EventKind, Path, build_content_area_for_path(), build_content_batch_reason(), build_content_changes(), build_content_reconciliation_changes(), build_content_watch_batch_drops_generated_manifests_without_hiding_real_changes() (+8 more)
...
Cohesion: 0.19
Nodes (13): vector, applyPlanToDirectory(), copyThenRemoveFile(), isPlainRegularFile(), isRegularFile(), PlannedFileTransfer, canRename, destination (+5 more)

### Community 487 - "Community 487"
Cohesion: 0.04
Nodes (53): Bad, Good, Multiple Binaries, proj-lib-main-split, Project Structure, See Also, Testing Benefits, Why It Matters (+45 more)
...
Cohesion: 0.11
Nodes (46): BuildPathSettingsService, DownloadService, InstalledModRecord, Logger, ModFileSummaryRecord, ModService, ofstream, ProfileModOrderItem (+38 more)
...
Cohesion: 0.18
Nodes (18): Client, Response, build_client(), cacheable_nexus_snapshot(), cached_nexus_api_snapshot(), fetch_nexus_api_snapshot(), legacy_v1_api_endpoint(), nexus_api_followup_targets_for_credential() (+10 more)
...
Cohesion: 0.04
Nodes (47): uintmax_t, FluxPackInstallPlan, automaticDownloadCount, manualDownloadCount, reusableDownloadCount, reusableSourceCount, sources, summary (+39 more)
...
Cohesion: 0.03
Nodes (78): FluxPackPackageType, function, path, FluxPackService, vector, wstring, BuildPathSettingsService, DownloadService (+70 more)
...
Cohesion: 0.02
Nodes (104): anti-stringly-typed, Bad, Error Messages, Good, Parsing Strings to Types, See Also, Why It Matters, With Serde (+96 more)
...
Cohesion: 0.22
Nodes (8): condition_variable, deque, DownloadTransferLimiter, mutex, vector, AppSettingsService, BuildPathSettingsService, Logger
...
Cohesion: 0.08
Nodes (24): api-impl-asref, AsRef vs Into vs Borrow, Bad, Common AsRef Implementations, Good, Implement AsRef for Custom Types, Pattern: Optional AsRef Bound, See Also (+16 more)
...
Cohesion: 0.05
Nodes (39): async-async-fn-bounds, Bad, Good, Key Points, See Also, The Three Variants, Why It Matters, async-cancel-safety (+31 more)

### Community 704 - "Community 704"
Cohesion: 0.11
Nodes (17): api-serde-optional, Bad, Feature Documentation, Good, Macro Pattern, Multiple Optional Dependencies, See Also, Testing with Features (+9 more)
...
Cohesion: 0.05
Nodes (41): anti-collect-intermediate, Bad, Comparison, Good, Iterator Methods That Avoid Collection, Pattern: Deferred Collection, See Also, When Collection Is Needed (+33 more)
...
Cohesion: 0.43
Nodes (8): ProfileOrderSeparatorMoveMode, moveProfileOrderStorageItems(), profileOrderMoveBlockEnd(), profileOrderMoveEnd(), ProfileOrderStorageItem, id, kind, reorderProfileOrderStorageItems()
...
- **Why does `thread` connect `Community 165` to `Community 4`, `Community 7`, `Community 26`, `Community 283`, `Community 285`, `Community 670`, `Community 159`, `Community 294`, `Community 815`, `Community 176`, `Community 181`, `Community 56`, `Community 58`, `Community 196`, `Community 70`, `Community 87`, `Community 221`, `Community 349`, `Community 96`, `Community 110`, `Community 255`?**
...
- **Why does `IService` connect `Community 582` to `Community 32`, `Community 40`, `Community 586`, `Community 172`, `Community 109`, `Community 110`, `Community 433`, `Community 179`, `Community 115`, `Community 341`, `Community 117`, `Community 183`, `Community 536`, `Community 57`, `Community 21`, `Community 219`, `Community 670`, `Community 543`?**
