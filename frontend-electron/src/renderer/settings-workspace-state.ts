...
export type SettingsSectionId = 'connections' | 'language' | 'theme' | 'transfer';
...
export const settingsSections: SettingsSection[] = [
  ...
  },
  {
    id: 'language',
    label: 'Language',
    description: 'Runtime interface language'
  },
  {
    id: 'theme',
    label: 'Кастомизация',
...
export const settingsCapabilityView = (bridgeStatus: NativeBridgeStatus | null) => {
  ...
  return {
    ...
    transferAvailable: features.mo2Transfer?.state === 'available'
  };
};
