    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Catalog =
        new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ["en"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["LegalBody"] = "Read the privacy policy, terms of use and third-party notices before installing Fluxora.",
                ["PrivacyTab"] = "Privacy policy",
                ["TermsTab"] = "Terms of use",
                ["NoticesTab"] = "Third-party notices",
            ...
            ["de"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["LegalBody"] = "Bitte lesen Sie die Datenschutzerklärung, die Nutzungsbedingungen und die Drittanbieter-Hinweise vor der Installation.",
                ["PrivacyTab"] = "Datenschutzerklärung",
                ["TermsTab"] = "Nutzungsbedingungen",
                ["NoticesTab"] = "Drittanbieter-Hinweise",
            ...
            ["ru"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["LegalBody"] = "Перед установкой Fluxora прочитайте политику конфиденциальности, условия использования и уведомления о сторонних компонентах.",
                ["PrivacyTab"] = "Политика конфиденциальности",
                ["TermsTab"] = "Условия использования",
                ["NoticesTab"] = "Сторонние компоненты",
